...
def get_assets() -> Dict[str, bytes]:
  ...
  mjx_env.update_assets(assets, consts.ROOT_PATH / "leapXELA_model" / "assets")
  mjx_env.update_assets(assets, consts.ROOT_PATH / "leapXELA_model", "*.xml")
  mjx_env.update_assets(
      assets, consts.ROOT_PATH / "leapXELA_model" / "reorientation_cube_textures"
  )
  mjx_env.update_assets(assets, consts.ROOT_PATH / "leapXELA_model" / "meshes")
  return assets
