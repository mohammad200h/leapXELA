...
from mujoco_playground._src.manipulation.leapXELA import reorient as leapxela_cube_reorient
from mujoco_playground._src.manipulation.leapXELA import rotate_z as leapxela_rotate_z
...
_envs = {
    ...
    "LeapXELACubeReorient": leapxela_cube_reorient.CubeReorient,
    "LeapXELACubeRotateZAxis": leapxela_rotate_z.CubeRotateZAxis,
}
...
_cfgs = {
    ...
    "LeapXELACubeReorient": leapxela_cube_reorient.default_config,
    "LeapXELACubeRotateZAxis": leapxela_rotate_z.default_config,
}

_randomizer = {
    "LeapCubeRotateZAxis": leap_rotate_z.domain_randomize,
    "LeapCubeReorient": leap_cube_reorient.domain_randomize,
    "LeapXELACubeReorient": leapxela_cube_reorient.domain_randomize,
    "LeapXELACubeRotateZAxis": leapxela_rotate_z.domain_randomize,
}
